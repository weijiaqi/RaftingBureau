...
public class StatusBarUtil {
     ...
     * 设置状态栏颜色
     *
     * @param activity 需要设置的 activity_release_scheme
     * @param color    状态栏颜色值
     */
    ...
    public static void setTransparentStatusBar(Activity activity, boolean useThemeColor) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (useThemeColor) {
                activity.getWindow()
                        .setStatusBarColor(ArmsUtils.getColor(activity, R.color.color_01));
            } else {
     ...
     *
     * @param activity       fragment 对应的 activity_release_scheme
     * @param needOffsetView 需要向下偏移的 View
     */
    ...
    private static void transparentStatusBar(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            // 底部虚拟键
            activity.getWindow().setNavigationBarColor(activity.getResources().getColor(R.color.color_01));
        } else {
            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        }
    }
