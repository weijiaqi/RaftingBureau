...
public class WebUrlConstant {
    public static final String USER_LICENSE = Api.WEB_BASEURL+"agreementAndroid";  //用户注册协议
    public static final String USER_PRIVACY = Api.WEB_BASEURL+"privacyAndroid";  //隐私协议
