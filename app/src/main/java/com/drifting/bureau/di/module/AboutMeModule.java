...
import com.drifting.bureau.mvp.model.AboutMeModel;
 ...
 */
@Module
 //构建AboutMeModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
public abstract class AboutMeModule {

    @Binds
    abstract AboutMeContract.Model bindAboutMeModel(AboutMeModel model);
}