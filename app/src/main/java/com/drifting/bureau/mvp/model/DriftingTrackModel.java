 ...
 */
@ActivityScope
public class DriftingTrackModel extends BaseModel implements DriftingTrackContract.Model{
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DriftingTrackModel(IRepositoryManager repositoryManager) {
