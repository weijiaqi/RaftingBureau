package com.drifting.bureau.mvp.ui.adapter.manager;
...
public class ArCardLayoutManager  extends RecyclerView.LayoutManager{
    @Override
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        int count = Math.min(getItemCount(), CardSwipeLayoutManager.CardConfig.CARD_SHOW_COUNT);
        if(count < 1) {
            return;
        }
        ...
        for (int i=0; i<count; i++) {
            ...
            child.setTranslationY(CardSwipeLayoutManager.CardConfig.TRANS_Y_GAP * fraction);
            child.setScaleX(1 - CardSwipeLayoutManager.CardConfig.SCALE_GAP*fraction);
            child.setScaleY(1 - CardSwipeLayoutManager.CardConfig.SCALE_GAP*fraction);
        }
    }

    public static void initCardConfig(Context context) {
        CardSwipeLayoutManager.CardConfig.init(context);
    }
