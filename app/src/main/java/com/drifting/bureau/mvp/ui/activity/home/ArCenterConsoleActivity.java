...
//    private CompletableFuture<ModelRenderable> model, model2, model3, model4, model5, model6, model7, model9, model10, model11;
...
//    private TransformableNode andy, andy2, andy3, andy4, andy5, andy7, andy9, andy10, andy11, andy13;
//    private View view;
...
//                    new Color(1, 0, 1, 1),
//                    new Color(1, 1, 1, 1));
//    private int nextColor,nextWorld2 = 0;
//
...
//                .build();
//
//        model4 = ModelRenderable.builder()
//                .setSource(this, Uri.parse("models/homeconsole.glb"))
//                .setIsFilamentGltf(true)
//                .setAsyncLoadEnabled(true)
//                .build();
//
...
//                        nextColor++;
//                        for (int i = 0; i < model.get().getSubmeshCount(); ++i) {
//                            Material material = model.get().getMaterial(i);
...
//                        andy2.setWorldScale(new Vector3(0.4f, 0.4f, 0.4f));
//                        andy2.setLocalPosition(new Vector3(1f, -3f, -2f));
...
//                        andy4.setWorldScale(new Vector3(0.5f, 0.5f, 0.5f));
//                        andy4.setLocalPosition(new Vector3(0.3f, -3.5f, -4f));
...
//                        andy5.setLocalPosition(new Vector3(0.5f, -1.2f, 0f));
...
//                                    andy7.select();
//
//                                    Color color2 = colors.get(nextWorld2);
//                                    nextWorld2++;
//                                    for (int i = 0; i < model7.get().getSubmeshCount(); ++i) {
//                                        Material material = model7.get().getMaterial(i);
...
//    }
//
//    @OnClick({R.id.tv_change_mode, R.id.rl_info, R.id.tv_about_me,  R.id.iv_photo, R.id.iv_close})
