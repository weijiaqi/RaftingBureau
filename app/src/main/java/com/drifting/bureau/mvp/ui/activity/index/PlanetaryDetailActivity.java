    ...
    public void initListener() {
        switch (type) {
            ...
            case 11:
                ...
                break;
            case 12:
                mIvPlanet.setImageResource(R.drawable.planetary_detail17);
                mTvName.setText("尧星");
                mTvDesc.setText("尧星球⼈是伟⼤的领导者和决策⼈。他们能轻易地看出事物具有的可能性，很⾼兴指导别⼈，使他们的想象成为现实。");
                mTvAttribute.setText("火焰、动物、天空、风");
                break;
            case 13:
