...
import com.drifting.bureau.mvp.ui.holder.ArAnswerHolder;
...
public class ArAnswerAdapter  extends BaseRecyclerAdapter<QuestionEntity> {
    ...
    public ArAnswerAdapter(List<QuestionEntity> infos, SeletChangeListener seletChangeListener) {
        super(infos);
    ...
    public void getHolder(BaseRecyclerHolder holder, int position) {
        ArAnswerHolder arAnswerHolder = (ArAnswerHolder) holder;
        arAnswerHolder.setData(mDatas, position);
    }

    @Override
    protected int getLayoutId(int viewType) {
        return R.layout.item_ar_answer;
    }

    @Override
    public BaseRecyclerHolder getCreateViewHolder(View view, int viewType) {
        return new ArAnswerHolder(view, this);
    }
