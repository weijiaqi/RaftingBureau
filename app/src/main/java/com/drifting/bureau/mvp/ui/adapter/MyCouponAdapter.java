...
public class MyCouponAdapter extends IndicatorViewPager.IndicatorFragmentPagerAdapter {
    ...
    public Fragment getFragmentForPage(int position) {
        return MyCouponFragment.newInstance(mChannelDatas.get(position).getType());
    }
