...
public interface MyCouponContract {
    ...
    interface View extends IView {
        ...
        void onCouponsMineSuccess(CouponsMineEntity entity, boolean isNotData);
    ...
    interface Model extends IModel{
        Observable<BaseEntity<CouponsMineEntity>> couponsmine(int page, int limit,int status,String scene);

        Observable<BaseEntity<CouponsMineEntity>> listForScene(int page, int limit,int status,String scene);
    }
}