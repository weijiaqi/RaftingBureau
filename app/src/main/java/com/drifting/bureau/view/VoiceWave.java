...
public class VoiceWave extends View {
    ...
    private void initData(int decibel) {
        ...
        if (decibel == 0) {
            ...
            dataList.add(new Bean(4, 10, 30));
            dataList.add(new Bean(5, 20, isQuiet ? 20 : base + 20));
            dataList.add(new Bean(6, isQuiet ? 10 : base + 20, 30));
            dataList.add(new Bean(7, 20, isQuiet ? 20 : base + 20));
            dataList.add(new Bean(8, isQuiet ? 10 : base + 50, 30));
            dataList.add(new Bean(9, 10, isQuiet ? 30 : base + 30));
            dataList.add(new Bean(10, isQuiet ? 10 : base + 20, 30));
            dataList.add(new Bean(11, 20, isQuiet ? 20 : base + 50));
            dataList.add(new Bean(12, isQuiet ? 10 : base + 50, 30));
            //-----------------------------------------------------
            dataList.add(new Bean(13, 20, isQuiet ? 20 : base + 70));
            //-----------------------------------------------------
            dataList.add(new Bean(14, isQuiet ? 10 : base + 50, 30));
            dataList.add(new Bean(15, 20, isQuiet ? 20 : base + 50));
            dataList.add(new Bean(16, isQuiet ? 10 : base + 20, 30));
            dataList.add(new Bean(17, 10, isQuiet ? 30 : base + 30));
            dataList.add(new Bean(18, isQuiet ? 10 : base + 50, 30));
            dataList.add(new Bean(19, 20, isQuiet ? 20 : base + 20));
            dataList.add(new Bean(20, isQuiet ?10 : base + 20, 30));
            dataList.add(new Bean(21, 20, isQuiet ? 20 : base + 20));
            dataList.add(new Bean(22, 10, 30));
            dataList.add(new Bean(23, isQuiet ? 20 : base + 35, 20));
            dataList.add(new Bean(24, 10, 30));//20
            dataList.add(new Bean(25, 10, 30));

            dataList.add(new Bean(26, 10, 30));
            dataList.add(new Bean(27, 10, 30));
            dataList.add(new Bean(28, isQuiet ? 20 : base + 35, 20));
            dataList.add(new Bean(29, 10, 30));
            dataList.add(new Bean(30, 20, isQuiet ? 20 : base + 20));
            dataList.add(new Bean(31, isQuiet ? 10 : base + 20, 30));
            dataList.add(new Bean(32, 20, isQuiet ? 20 : base + 20));
            dataList.add(new Bean(33, isQuiet ? 10 : base + 50, 30));
            dataList.add(new Bean(34, 10, isQuiet ? 30 : base + 30));
            dataList.add(new Bean(35, isQuiet ? 10 : base + 20, 30));
            dataList.add(new Bean(36, 20, isQuiet ? 20 : base + 50));
            dataList.add(new Bean(37, isQuiet ? 10 : base + 50, 30));
            //-----------------------------------------------------
            dataList.add(new Bean(38, 20, isQuiet ? 20 : base + 70));
            //-----------------------------------------------------
