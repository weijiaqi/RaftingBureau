        ...
        for (int i = 0; i < radarItemSize; i++) {
            ...
            for (int j = 0; j < netLineNum; j++) {//画网线
                ...
                if (j == 0) {
                    ...
                    if (i == 1 || i == radarItemSize - 1) {
                        drawLabel(canvas, textPaint, radarItem.labelName, labelCenterX, labelCenterY + 30, -90 + perDegree * i);//画标签
                    } else if (i == 2 || i == radarItemSize - 2) {
                        drawLabel(canvas, textPaint, radarItem.labelName, labelCenterX, labelCenterY + 10, -90 + perDegree * i);//画标签
                    } else {
