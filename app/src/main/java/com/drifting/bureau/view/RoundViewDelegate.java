...
public class RoundViewDelegate {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        backgroundGradientAngle = ta.getInt(R.styleable.RoundTextView_rv_backgroundGradientAngle, 0);
        backgroundColorStart = ta.getColor(R.styleable.RoundTextView_rv_backgroundColorStart, Color.TRANSPARENT);
        backgroundColorEnd = ta.getColor(R.styleable.RoundTextView_rv_backgroundColorEnd, Color.TRANSPARENT);
    ...
    public void setBackgroundColor(int backgroundColor) {
        ...
        this.backgroundColorStart = Color.TRANSPARENT;
        this.backgroundColorEnd = Color.TRANSPARENT;
        setBgSelector();
    }
    ...
    private void setDrawable(GradientDrawable gd, int color, int strokeColor) {
        if (backgroundColorStart == Color.TRANSPARENT || backgroundColorEnd == Color.TRANSPARENT) {
            gd.setColor(color);
        } else {
            int[] colors = {backgroundColorStart, backgroundColorEnd};
            gd.setColors(colors);
            GradientDrawable.Orientation mOrientation = GradientDrawable.Orientation.LEFT_RIGHT;
            switch (backgroundGradientAngle) {
                case 0:
